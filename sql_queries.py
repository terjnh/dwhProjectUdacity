...
# Example JSON file:
# https://github.com/jukkakansanaho/udacity-dend-project-3/blob/master/data/log_data/2018-11-01-events.json
...
# Example JSON file:
#https://github.com/jukkakansanaho/udacity-dend-project-3/tree/master/data/song_data/A/A/A
